...
class Popular():
    ...
    global train_data
    data= pd.read_csv('neural/popular.csv', sep=';', names=['label', 'text'], encoding='cp1251')    # Dataset по категориям
    train_data = pd.read_csv('neural/test-popular.csv', sep=';', names=['label', 'text'],
